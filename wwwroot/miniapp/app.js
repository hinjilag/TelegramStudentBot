  ...
  return `
    <div class="focus-grid">
      ...
      <section class="module panel">
        ...
        <div class="divider"></div>
        <p class="muted">Чат и mini app используют одни и те же настройки, поэтому изменения сразу синхронизируются между интерфейсами. Напоминания будут приходить и по ДЗ, и по личным делам.</p>
      </section>
    </div>
  `;
}
